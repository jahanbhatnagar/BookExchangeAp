...
import LogoDonor from './LogoDonor';
...
export default class BookDonarScreen extends Component {
    constructor(props) {
        super(props);
        this.state = {
        isLoading: false,
    ...
    _confirmationAlert=()=> {
        Alert.alert(
          'Hey Donator',
          'Books Successfully Added in Library....!',
          [
              ...
              <View style={styles.inputWrap}>
                ...
                <View style={styles.inputWrap}>
                    ...
                    <TouchableOpacity
                        ...
                        <Text style={styles.text}>Add Books In Store</Text>
                        )}
                    </TouchableOpacity>
                    <Animated.View
